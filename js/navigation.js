 ...
 **/
! function(e) { e.fn.hoverIntent = function(t, n, o) { var r = { interval: 100, sensitivity: 7, timeout: 0 };
        r = "object" == typeof t ? e.extend(r, t) : e.isFunction(n) ? e.extend(r, { over: t, out: n, selector: o }) : e.extend(r, { over: t, out: t, selector: n }); var v, u, i, s, h = function(e) { v = e.pageX, u = e.pageY },
            ...
            c = function(t) { var n = jQuery.extend({}, t),
                    o = this;
 ...
 */
! function(e, i) {
    function n(i, n) { this.element = i, this.$elem = e(this.element), this.options = e.extend({}, t, n), this.init() } var s = "slimmenu",
        t = { resizeWidth: "768", collapserTitle: "Main Menu", animSpeed: "medium", easingEffect: null, indentChildren: !1, childrenIndenter: "&nbsp;&nbsp;" },
        l = 0;
    n.prototype = { init: function() { var n, s = this.options,
                t = this.$elem,
            ...
            t.before(l), n = t.prev(".menu-collapser"), t.on("click", ".sub-collapser", function(i) { i.preventDefault(), i.stopPropagation(); var n = e(this).closest("li");
                e(this).hasClass("expanded") ? (e(this).removeClass("expanded"), e(this).find("i").html("&#9660;"), n.find(">ul").slideUp(s.animSpeed, s.easingEffect)) : (e(this).addClass("expanded"), e(this).find("i").html("&#9650;"), n.find(">ul").slideDown(s.animSpeed, s.easingEffect)) }), n.on("click", ".collapse-button", function(e) { e.preventDefault(), t.slideToggle(s.animSpeed, s.easingEffect) }), this.resizeMenu({ data: { el: this.element, options: this.options } }), e(i).on("resize", { el: this.element, options: this.options }, this.resizeMenu) }, resizeMenu: function(s) { var t = e(i),
                a = s.data.options,
                o = e(s.data.el),
                d = e("body").find(".menu-collapser");
            l != t.width() && (l = t.width(), o.find("li").each(function() { e(this).has("ul").length && (e(this).has(".sub-collapser").length ? e(this).children(".sub-collapser i").html("&#9660;") : e(this).append('<span class="sub-collapser"><i>&#9660;</i></span>')), e(this).children("ul").hide(), e(this).find(".sub-collapser").removeClass("expanded").children("i").html("&#9660;") }), a.resizeWidth >= t.width() ? (a.indentChildren && o.find("ul").each(function() { var i = e(this).parents("ul").length;
